...
Use Database SubQuery_database;
...
Select user_id, Count(song_id) AS Songs_plays
From songs_weekly
...
Select user_id, song_id, SUM(Song_plays) AS Songs_Count
From (
    Select user_id, song_id, song_plays 
    From songs_history
    ...
    Select user_id, song_id,Count(song_id) AS Songs_plays
    From songs_weekly
    Where Date(listen_time) <= '2022-08-04'
